...
export default function JourneyDetailsScreen() {
  ...
  const refreshMedia = useCallback(async () => {
    try { setMedia(await mediaApi.list(id)); } finally { setMediaLoading(false); }
  }, [id]);
  useFocusEffect(useCallback(() => { void refreshMedia(); }, [refreshMedia]));
